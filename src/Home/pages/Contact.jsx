    ...
    <div className="pb-10 ">
      <div className="px-[8vw]  grid grid-cols-1 md:grid-cols-2    items-center bg-[#425DAC] min-h-screen" style={{ backgroundImage: "url('https://html.tonatheme.com/2024/intelytech/images/background/banner-01.png')" }}>
        <div className="space-y-6 mt-14">
          <h1 className="text-4xl font-bold text-[#54B685]">We offer end-to-end AI solutions for your business needs</h1>
          <p className="text-lg text-gray-300">Eu pellentesque duis consectetur sem amet massa. Vulputate magna convallis malesuada in sagittis. Scelerisque pulvinar mollis enim sed ornare felis lacinia aliquam.</p>

          <div className=" ">
            <p className="text-xl text-gray-300 font-semibold p-5 border-t-2 border-white border-b-2">Connect with other AI enthusiasts and experts for a positive impact on the world</p>
          </div>
